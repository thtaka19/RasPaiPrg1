/**********************************************************************
 *
 * Filename:    led11.c Same as cmn00/led10.c 
 * 		only [#include "../cmn00/gpio_LedAddress.h" is not same
...
//	  printf("Debug LedTogPin  Pin=%d\r\n>",PinNo);
	  if( gpio_read(PinNo) ) // If GPIO On 
	  {
//	  printf("Debug LedTogPin Clear Call Pin=%d\r\n>",PinNo);
		gpio_clear(PinNo); // 	GPIOPin clear
	   }
	   else {
//		 printf("Debug LedTogPin Set Call Pin=%d\r\n>",PinNo);
		gpio_set(PinNo);// 		GPIOPin Set
	   }
	} // if end
