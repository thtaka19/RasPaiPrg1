...
#line 12 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_12 = 12;
#define MAIN_TASK	(<>)
#line 12 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_12 = (unsigned_t)(TA_ACT);
#line 12 "../21_0blk0/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_12 = (signed_t)(MAIN_PRIORITY);
#line 12 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_12 = (unsigned_t)(STACK_SIZE);

#line 14 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_13 = 13;
#define EXC_TASK	(<>)
#line 14 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_13 = (unsigned_t)(TA_NULL);
#line 14 "../21_0blk0/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_13 = (signed_t)(EXC_PRIORITY);
#line 14 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_13 = (unsigned_t)(STACK_SIZE);

#line 16 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_14 = 14;
#define CYCHDR1	(<>)
#line 16 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_cycatr_14 = (unsigned_t)(TA_NULL);
#line 16 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_nfymode_14 = (unsigned_t)(TNFY_HANDLER);
#line 16 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_cyctim_14 = (unsigned_t)(2000000);
#line 16 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_cycphs_14 = (unsigned_t)(0);

#line 18 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_15 = 15;
#define ALMHDR1	(<>)
#line 18 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_almatr_15 = (unsigned_t)(TA_NULL);
#line 18 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_nfymode_15 = (unsigned_t)(TNFY_HANDLER);

#ifdef INTNO1

#line 20 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_16 = 16;
#line 20 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_16 = (unsigned_t)(INTNO1);
#line 20 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_intatr_16 = (unsigned_t)(INTNO1_INTATR);
#line 20 "../21_0blk0/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_intpri_16 = (signed_t)(INTNO1_INTPRI);

#line 21 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_17 = 17;
#define INTNO1_ISR	(<>)
#line 21 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_isratr_17 = (unsigned_t)(TA_NULL);
#line 21 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_17 = (unsigned_t)(INTNO1);
#line 21 "../21_0blk0/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_isrpri_17 = (signed_t)(1);

#endif

#ifdef CPUEXC1

#line 24 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_18 = 18;
#line 24 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_excno_18 = (unsigned_t)(CPUEXC1);
#line 24 "../21_0blk0/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_excatr_18 = (unsigned_t)(TA_NULL);
