...
void delay00_ms(unsigned int milliseconds)
{
  delay(milliseconds);
}
/**********************************************************************
...
void cliCommandTask3(intptr_t exinf)
{
   ...
   m_serialPutStr("Monitor and Control Program 21_50 S\r\n");
		aqm0802_cleardisplay();
LCDputs("21_5 v1");//aqm0802_print_tart
  m_serialPutStr("21_5 \r\n");	
	
    m_serialPutStr("Monitor and Control Program 21_50 1V1 \r\n");
...
//        rcvChar = m_serialGetChar();
	...
	// 	m_serialPutChar('3');// Debug 2020 May
