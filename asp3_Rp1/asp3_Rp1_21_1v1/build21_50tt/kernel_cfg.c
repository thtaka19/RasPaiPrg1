...
static STK_T _kernel_stack_TASK4[COUNT_STK_T(STACK_SIZE)];
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_NULL), (intptr_t)(1), (TASK)(t100msTask1), INT_PRIORITY(HIGH_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK1 },
	{ (TA_NULL), (intptr_t)(2), (TASK)(t500msTask2), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK2 },
	{ (TA_NULL), (intptr_t)(3), (TASK)(cliCommandTask3), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK3 },
	{ (TA_NULL), (intptr_t)(4), (TASK)(processTask4), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK4 },
...
const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_LogTask_Task, TASK1, TASK2, TASK3, TASK4, MAIN_TASK, EXC_TASK
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	...
	{ (TA_NULL), (intptr_t)(0), (NFYHDR)(cyclic_handler10), (10000), (500) }
};
